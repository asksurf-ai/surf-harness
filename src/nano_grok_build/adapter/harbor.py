...
class NanoGrokBuildAgent(BaseAgent):
    ...
    def populate_context_post_run(self, context: AgentContext) -> None:
        ...
        try:
            ...
            context.cost_usd = publication.context.get("cost_usd")
            context.metadata = {
            ...
            if publication.cost_usd_observed_lower_bound is not None:
                context.metadata["provider_cost_usd_observed_lower_bound"] = (
                    publication.cost_usd_observed_lower_bound
                )
                context.metadata["provider_cost_usd_is_lower_bound"] = (
                    context.cost_usd is None
                )
