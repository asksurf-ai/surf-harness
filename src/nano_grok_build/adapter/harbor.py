...
class NanoGrokBuildAgent(BaseAgent):
        ...
        payload = canonical_json(
            {
                ...
                "background_count": lease.process_count,
        ...
        try:
            if escrow is None:
                ...
                status = await rehydrate_git_history_for_verifier(
                    ...
                    background_process_count=lease.process_count,
    ...
    async def prepare_shared_verifier_v1(
        ...
        *,
        ...
        """Restore an eligible original Git database immediately before verification."""
