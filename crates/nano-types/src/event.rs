...
mod tests {
    ...
    use super::{
        EVENT_SCHEMA, Event, EventBody, LEGACY_EVENT_SCHEMA, LEGACY_RUN_RECORD_SCHEMA,
        LegacyTerminalStatus, MEDIA_HISTORY_POLICY_SHA256, MEDIA_HISTORY_POLICY_VERSION,
        MediaHistoryRequestReceiptV1, ProviderBudgetObservationV1, ProviderBudgetPhaseV1,
        ProviderCallCoverage, ProviderFailed, ProviderRequested, RUN_RECORD_SCHEMA,
        RUN_RECORD_V3_SCHEMA, RunCompleted, RunRecord, RunRecordV3, RunStarted,
