...
mod tests {
    ...
    #[test]
    fn tracked_contract_has_exact_three_file_identity() {
        ...
        assert_eq!(
            ...
            "f43e9f6a39dd467188c60121b547460077cd6683bb9c38b65b9210e2090fd50a"
        );
        assert_eq!(contract.profile().profile_id, "nano-v1-grok-4-6-high-v1");
        assert_eq!(contract.profile().provider.model, "grok-4.6");
        assert_eq!(
            contract.effective().system_prompt.utf8_sha256,
            "5eb5ac7af248ee4020f24fe2d252bfb4cd76ff2490b9887db9183ad5e7448e17"
        );
        assert!(
            contract
                .effective()
