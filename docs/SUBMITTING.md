...
- Agent `nano-grok-build`, version `0.6.4`.
- Model `xai/grok-4.6`, reasoning effort `high`, service tier `default`.
...
- Git-history capability policy `nano-git-history-capability-policy-v4`.
