...
Version `0.6.0` reuses the exact owner-approved `0.5.5` contract artifacts and
adds a hash-chained lifecycle coordinator with separate execution, verifier,
and submission outcomes. Ordinary runtime and publication errors preserve
native verifier truth; only typed safety hazards suppress verification. It
remains a scored candidate until the independent release gate passes. The last
