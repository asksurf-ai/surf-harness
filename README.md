...
Version `0.5.6` reuses the exact owner-approved `0.5.5` contract artifacts and
adds one bounded acceptance-spec replay plus Git-history admission hardening.
It remains a scored candidate until the preregistered paired gate passes. The
last evaluated public source remains the immutable
