...
Version `0.4.3` retains the exact, owner-approved task-neutral
workspace-integrity contract, fail-closed topology-aware Git-history admission,
and immutable task-image binding. Its provider-free setup runner now preserves
the exact Harbor virtual-environment Python invocation through strict prelaunch
identity checks. No leaderboard score is claimed until five complete, public,
audited jobs pass the upstream submission checks.
