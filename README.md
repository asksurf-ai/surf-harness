...
[`v0.5.0`](https://github.com/asksurf-ai/surf-harness/tree/v0.5.0) tag. Public
...
| Evidence-preserving context checkpoint | One task-neutral reset keeps the original request, workspace, bounded structural ledger, and recent tool locators; a typed event binds old and new history hashes | Long trajectories stop paying to resend stale conversation without silently pretending the lost history is still authoritative. |
