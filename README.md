...
The current `0.5.2` source is an evaluation candidate for a fresh bounded
provider-on paired gate. It is not yet a K=5 candidate. The 0.5.1 K=5 cohort scored 351/445
and did not establish uplift. Results become submission candidates only after
the provider-on gate and trajectory audit described in
