...
Version `0.6.1` reuses the exact owner-approved `0.5.5` contract artifacts and
...
and strictly deduplicates equal terminal transport copies. Ordinary runtime and
publication errors preserve native verifier truth; only typed safety hazards
suppress verification. It remains a scored candidate until the independent
