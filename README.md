...
Version `0.4.2` retains the exact, owner-approved task-neutral
workspace-integrity contract and fail-closed topology-aware Git-history
admission. Its provider-free setup smoke accepts the frozen TB2.1 inventory's
official tag-form task images only after binding them to immutable local image
IDs. No leaderboard score is claimed until five complete, public, audited jobs
pass the upstream submission checks.
