...
Version `0.5.9` reuses the exact owner-approved `0.5.5` contract artifacts and
adds receipt-before-marker Git-history lifecycle proof, fail-closed publication,
and exact provider-cost projection. It remains a scored candidate until the
