...
Version `0.5.5` is a release candidate whose changed contract bytes require
fresh exact owner approval and immutable public-source binding. It cannot be
exported or used for a scored run while that gate is pending. The last evaluated
public source remains the immutable
