...
Version `0.4.1` retains the exact, owner-approved task-neutral
workspace-integrity contract and adds fail-closed topology-aware Git-history
admission plus frozen all-task authority. No leaderboard score is claimed
