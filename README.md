...
The current `0.5.3` source is an evaluation candidate for a fresh bounded
provider-on paired gate. It is not yet a K=5 candidate. The 0.5.2 paired gate
tied 8/12 and did not establish uplift. Results become submission candidates
